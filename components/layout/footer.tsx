      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold bg-linear-to-r from-primary to-pink-500 bg-clip-text text-transparent">
              FileConvert Pro
            </h3>
            <p className="text-sm text-muted-foreground">
              Professional file conversion with OCR support. Fast, secure, and
              free.
            </p>
          </div>
